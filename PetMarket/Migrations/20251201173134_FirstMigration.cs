    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPaymentStatus = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPet = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TypePet = table.Column<string>(type: "text", nullable: false),
                    ImagePetUrl = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAddresses_Addresses_IdAddress",
                        column: x => x.IdAddress,
                        principalTable: "Addresses",
                        principalColumn: "IdAddress",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandProduct = table.Column<string>(type: "text", nullable: false),
                    DescriptionProduct = table.Column<string>(type: "text", nullable: false),
                    PriceProduct = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    StockProduct = table.Column<int>(type: "integer", nullable: false),
                    ImageProductUrl = table.Column<string>(type: "text", nullable: true),
                    IdCategory = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdOrderStatus = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatuses_Orders_IdOrder",
                        column: x => x.IdOrder,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdOrder = table.Column<int>(type: "integer", nullable: false),
                    IdPaymentStatus = table.Column<int>(type: "integer", nullable: false),
                    PaymentStatusIdPaymentStatus = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.PaymentStatusIdPaymentStatus,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdShippingMethod = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingMethods", x => x.IdShippingMethod);
                    table.ForeignKey(
                        name: "FK_ShippingMethods_Orders_IdOrder",
                        column: x => x.IdOrder,
                        principalTable: "Orders",
                        principalColumn: "IdOrder",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdFavorites = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    IdProduct = table.Column<int>(type: "integer", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdOrderDetails = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdShoppingCartItem = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_ShoppingCarts_IdShoppingCart",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingMethods_IdOrder",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_IdShoppingCart",
                table: "ShoppingCartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAddresses_IdAddress",
                table: "UserAddresses",
                column: "IdAddress");
